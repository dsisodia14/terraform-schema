...
var expectedMergedSchema_v013 = &schema.BodySchema{
	Blocks: map[string]*schema.BlockSchema{
		"provider": {
			...
			Body: &schema.BodySchema{
				Attributes: map[string]*schema.AttributeSchema{
					"alias": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
				},
			},
		...
		"resource": {
			...
			Body: &schema.BodySchema{
				Attributes: map[string]*schema.AttributeSchema{
					"count": {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
				},
			},
			DependentBody: map[schema.SchemaKey]*schema.BodySchema{
				`{"labels":[{"index":0,"value":"grafana_alert_notification"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"frequency":     {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"id":            {Expr: schema.LiteralValueOnly(cty.String), IsComputed: true, IsOptional: true},
						"is_default":    {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
						"name":          {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"send_reminder": {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
						"settings": {
							Expr:       schema.LiteralValueOnly(cty.Map(cty.String)),
							IsOptional: true,
						},
						"type": {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"uid":  {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
					},
				},
				`{"labels":[{"index":0,"value":"grafana_dashboard"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"config_json": {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"folder":      {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
						"id":          {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
						"slug":        {IsComputed: true, Expr: schema.LiteralValueOnly(cty.String)},
					},
				},
					...
					Blocks: map[string]*schema.BlockSchema{
						"json_data": {
							...
							Body: &schema.BodySchema{
								Blocks: map[string]*schema.BlockSchema{},
								Attributes: map[string]*schema.AttributeSchema{
									"assume_role_arn":           {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"auth_type":                 {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"conn_max_lifetime":         {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
									"custom_metrics_namespaces": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"default_region":            {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"encrypt":                   {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"es_version":                {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
									"graphite_version":          {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"http_method":               {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"interval":                  {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"log_level_field":           {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"log_message_field":         {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"max_idle_conns":            {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
									"max_open_conns":            {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
									"postgres_version":          {Expr: schema.LiteralValueOnly(cty.Number), IsOptional: true},
									"query_timeout":             {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"ssl_mode":                  {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"time_field":                {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"time_interval":             {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"timescaledb":               {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
									"tls_auth":                  {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
									"tls_auth_with_ca_cert":     {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
									"tls_skip_verify":           {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
									"tsdb_resolution":           {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"tsdb_version":              {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
								},
							},
						},
						"secure_json_data": {
							...
							Body: &schema.BodySchema{
								Blocks: map[string]*schema.BlockSchema{},
								Attributes: map[string]*schema.AttributeSchema{
									"access_key":          {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"basic_auth_password": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"password":            {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"private_key":         {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"secret_key":          {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"tls_ca_cert":         {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"tls_client_cert":     {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
									"tls_client_key":      {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
								},
							},
						},
					},
					Attributes: map[string]*schema.AttributeSchema{
						"access_mode":         {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"basic_auth_enabled":  {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
						"basic_auth_password": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"basic_auth_username": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"database_name":       {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"id":                  {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
						"is_default":          {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
						"name":                {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"password":            {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"type":                {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"url":                 {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"username":            {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
					},
				},
				`{"labels":[{"index":0,"value":"grafana_folder"}]}`: {
					...
					Attributes: map[string]*schema.AttributeSchema{
						"id":    {Expr: schema.LiteralValueOnly(cty.String), IsComputed: true, IsOptional: true},
						"title": {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"uid":   {IsComputed: true, Expr: schema.LiteralValueOnly(cty.String)},
					},
				},
				`{"labels":[{"index":0,"value":"grafana_organization"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"admin_user": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"admins": {
							Expr:       schema.LiteralValueOnly(cty.List(cty.String)),
							IsOptional: true,
						},
						"create_users": {Expr: schema.LiteralValueOnly(cty.Bool), IsOptional: true},
						"editors": {
							Expr:       schema.LiteralValueOnly(cty.List(cty.String)),
							IsOptional: true,
						},
						"id":     {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
						"name":   {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"org_id": {IsComputed: true, Expr: schema.LiteralValueOnly(cty.Number)},
						"viewers": {
							Expr:       schema.LiteralValueOnly(cty.List(cty.String)),
							IsOptional: true,
						},
				...
				`{"labels":[{"index":0,"value":"grafana_team"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"email": {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"id":    {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
						"members": {
							Expr:       schema.LiteralValueOnly(cty.List(cty.String)),
							IsOptional: true,
						...
						"name":    {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"team_id": {IsComputed: true, Expr: schema.LiteralValueOnly(cty.Number)},
					},
				},
				`{"labels":[{"index":0,"value":"grafana_user"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"email":    {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"id":       {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true, IsComputed: true},
						"login":    {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"name":     {Expr: schema.LiteralValueOnly(cty.String), IsOptional: true},
						"password": {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
					},
				},
		...
		"data": {
			...
			DependentBody: map[schema.SchemaKey]*schema.BodySchema{
				...
				`{"labels":[{"index":0,"value":"terraform_remote_state"}]}`: {
					...
					Blocks: map[string]*schema.BlockSchema{},
					Attributes: map[string]*schema.AttributeSchema{
						"backend":   {IsRequired: true, Expr: schema.LiteralValueOnly(cty.String)},
						"config":    {IsOptional: true, Expr: schema.LiteralValueOnly(cty.DynamicPseudoType)},
						"defaults":  {IsOptional: true, Expr: schema.LiteralValueOnly(cty.DynamicPseudoType)},
						"outputs":   {IsComputed: true, Expr: schema.LiteralValueOnly(cty.DynamicPseudoType)},
						"workspace": {IsOptional: true, Expr: schema.LiteralValueOnly(cty.String)},
					},
				},
			},
		},
